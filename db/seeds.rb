...
user2 = User.create!(email:"user2@gmail.com" , password:"00
Edit Dele
Edit Dele0000" , age:"25" , address:"1234", first_name:"user2" , last_name:"last2")
...
item4 = Item.create!(name:"Faucon Millenium" , description:"Pour un
Edit Dele séjour inoubliable!" , price:989, user: user4 )
